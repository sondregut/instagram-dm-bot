    ...
    <div className="text-center py-12 px-6">
      ...
      {onConnectClick && (
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-accent to-accent-secondary text-white font-medium rounded-lg hover:opacity-90 transition-all text-sm shadow-sm"
        >
